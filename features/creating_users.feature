Feature: Creating Users
  In order ot add new users to the system
  As an admin
  ...
  Scenario: Creating a new user
    And I fill in "Email" with "newbie@ticketeeme.com"
  ...
  Scenario: Creating an admin user
    When I fill in "Email" with "newadmin@ticketeeme.com"
    And I fill in "Password" with "password"
    And I check "Is an admin?"
    And I press "Create User"
    Then I should see "User has been created"
    And I should see "newadmin@ticketeeme.com (Admin)"
