Feature: Editing a user
  ...
  Scenario: Updating a user's details
    When I fill in "Email" with "newguy@ticketeeme.com"
    And I press "Update User"
    Then I should see "User has been updated."
    And I should see "newguy@ticketeeme.com"
    And I should not see "user@ticketeeme.com"

  Scenario: Toggling a user's admin ability
    When I check "Is an admin?"
    And I press "Update User"
    Then I should see "User has been updated."
    And I should see "user@ticketeeme.com (Admin)"
