Feature: Hidden Links
  ...
  Background:
    ...
    And "user@ticketeeme.com" can view the "TextMate 2" project
  ...
  Scenario: New project link is shown to admins
    Given I am signed in as "admin@ticketeeme.com"
  ...
  Scenario: Edit projet link is shown to admins
    Given I am signed in as "admin@ticketeeme.com"
    When I follow "TextMate 2"
  ...
  Scenario: New ticket link is shown to a user with permission
    Given "user@ticketeeme.com" can view the "TextMate 2" project
    And "user@ticketeeme.com" can create tickets on the "TextMate 2" project
    And I am signed in as "user@ticketeeme.com"
    When I follow "TextMate 2"
  ...
  Scenario: Edit ticket link is shown to a user with permission
    Given "user@ticketeeme.com" can view the "TextMate 2" project
    And "user@ticketeeme.com" can edit tickets on the "TextMate 2" project
    And I am signed in as "user@ticketeeme.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
  ...
  Scenario: Delete ticket link is shown to a user with permission
    Given "user@ticketeeme.com" can view the "TextMate 2" project
    And "user@ticketeeme.com" can delete tickets in the "TextMate 2" project
    And I am signed in as "user@ticketeeme.com"
    When I follow "TextMate 2"
    And I follow "Shiny!"
